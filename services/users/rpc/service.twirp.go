...
func (c *usersProtobufClient) Register(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "ms.users")
...
func (c *usersJSONClient) Register(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "ms.users")
	ctx = ctxsetters.WithServiceName(ctx, "Users")
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	out := new(RegisterResponse)
...
const UsersPathPrefix = "/twirp/ms.users.Users/"
...
func (s *usersServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/ms.users.Users/Register":
